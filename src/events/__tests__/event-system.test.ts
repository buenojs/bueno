...
describe('Event System', () => {
  ...
  describe('Event Registry', () => {
    ...
    it('should support event history', () => {
      const events = [
        createEvent('test.event', { count: 1 }, { timestamp: new Date(Date.now() - 3000) }),
        createEvent('test.event', { count: 2 }, { timestamp: new Date(Date.now() - 2000) }),
        createEvent('test.event', { count: 3 }, { timestamp: new Date(Date.now() - 1000) })
      ];
